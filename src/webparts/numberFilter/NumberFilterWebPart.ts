...
import { IPropertyPaneConfiguration, PropertyPaneTextField, PropertyPaneToggle, PropertyPaneDropdown, PropertyPaneChoiceGroup } from "@microsoft/sp-property-pane";
